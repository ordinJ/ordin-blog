package com.ordin.controller;

import com.github.pagehelper.PageInfo;
import com.ordin.constant.WebConst;
import com.ordin.controller.base.BaseController;
import com.ordin.dto.ErrorCode;
import com.ordin.dto.Types;
import com.ordin.model.Comments;
import com.ordin.model.Contents;
import com.ordin.model.bo.*;
import com.ordin.service.CommentService;
import com.ordin.service.ContentService;
import com.ordin.service.InstallService;
import com.ordin.service.MetasService;
import com.ordin.util.BlogUtils;
import com.ordin.util.DateKit;
import com.ordin.util.IPUtils;
...
public class IndexController extends BaseController{
     ...
     * @param p       第几页
     * @param limit   每页大小 (后端限制12条)
     * @return 主页
     */
    @RequestMapping(value = "/page/{p}")
    public String index(HttpServletRequest request, @PathVariable int p, @RequestParam(value = "limit", defaultValue = "12") int limit) {
        p = p < 0 || p > WebConst.MAX_PAGE ? 1 : p;
        PageInfo<Contents> articles = contentService.getContents(p, 12);
    ...
    public String search(HttpServletRequest request,@RequestParam("keyword") String keyword){
